...
/***/ function(module, exports, __webpack_require__) {
	...
	var FilterTable = React.createClass({
	    ...
	    getInitialState: function getInitialState() {
	        return {
	            table: ['apple', 'banana', 'peach', 'pear', 'orange', 'apple pie', 'strawberry', 'blueberry'],
	            filteredTable: []
	        };
	    },

	    componentWillMount: function componentWillMount() {
	        this.setState({ filteredTable: this.state.table });
	    },
	    filter: function filter(event) {
	        var filteredTable = this.state.table.filter(function (item) {
	    ...
	    render: function render() {
	        return React.createElement(
	            'div',
	            null,
	            React.createElement('input', { type: 'text', value: this.state.filter, onChange: this.filter }),
	            React.createElement(
	                'div',
	                null,
	                React.createElement(Table, { items: this.state.filteredTable })
	            )
	        );
	    }
	});

	ReactDOM.render(React.createElement(FilterTable, null), document.getElementById('filter'));
